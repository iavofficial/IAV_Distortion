...
class CarMap:
    ...
    def check_vehicle_proximity(self,vehicle_id: str, position: dict,) -> None:
        ...
        proximity_vehicle_id: str = self._environment_manager.get_vehicle_by_vehicle_id(vehicle_id)._vehicle_in_proximity
        if proximity_vehicle_id != None:
            ...
            if pos_proximity_vehicle.distance_to(pos_self) > 200:
                self._environment_manager.get_vehicle_by_vehicle_id(vehicle_id)._vehicle_in_proximity = None
        else:
            for vehicle in self._vehicles:
                if vehicle.vehicle_id != vehicle_id:
                    ...
                    if pos_other.distance_to(pos_self) < 200:
                        ...
                        self._environment_manager.get_vehicle_by_vehicle_id(vehicle_id)._vehicle_in_proximity = vehicle.vehicle_id
        return
